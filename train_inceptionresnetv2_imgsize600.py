...
from faster_rcnn.faster_rcnn_inceptionresnetv2_imgsize600 import FasterRCNN, RPN
...
output_dir = '/disk2/data/pytorch_models/trained_models/inceptionresnetv2_imgsize600/saved_model3'
...
print params[528].size()
# optimizer = torch.optim.Adam(params[-8:], lr=lr)
optimizer = torch.optim.SGD(params[528:], lr=lr, momentum=momentum, weight_decay=weight_decay)
